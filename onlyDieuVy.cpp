...
int main()
{
	...
	while (true)
	{
		system("cls");
		cout << endl << endl;
		cout << "\t\tTran Dieu Vy co xinh dep khong ? ";
		getline(cin, co);
		if (co == "CO")
		{
			cout << "\t\t---CAU Tra Loi Rat Dung !---" << endl << endl;
			cout << "\t\tTran Dieu Vy 6-2-2005..." << endl;
			Sleep(1000);
			cout << "\t\tonly Dieu Vy" << endl; Sleep(1000);
			cout << "\t\tonly Dieu Vy" << endl; Sleep(1000);
			cout << "\t\tonly Dieu Vy" << endl; Sleep(1000);
			cout << "\t\tonly Dieu Vy" << endl; Sleep(1000);
			cout << "\t\tonly Dieu Vy" << endl; Sleep(1000);
			...
			while (true)
			{
				...
				ifstream file;
				file.open("C:\\Users\\Laptop\\Downloads\\banner.txt", ios_base::in); //import file thì copy du?ng d?n r?i d?i \ thành \\ ho?c /
				string line;
